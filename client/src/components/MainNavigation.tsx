...
import {
  upsertPendingGame,
  removePendingGame,
} from "../stores/queuedGamesSlice";
import { upsertOnGoingGame } from "../stores/activeGamesSlice";
  ...
  return (
    <>
      <div className="bg-white max-w-screen-lg mx-auto flex justify-between p-4">
        ...
        <MainNavigation className="space-y-4">
...
const MainNavigation = () => {
  ...
  return (
    <MainNavigation className="p-4 bg-gray-200 dark:bg-gray-800">
      <button
        className="text-sm px-4 py-2 bg-blue-500 text-white dark:bg-blue-700 rounded"
